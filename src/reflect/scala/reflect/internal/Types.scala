...
*/
   ...
   *  contravariant positions are replaced by lower bounds, provided the
...
//            assert((tparams1 map (_.typeParams.length)) == (tparams2 map (_.typeParams.length)))
   ...
   */
  private def specializesSym(tp1: Type, sym1: Symbol, tp2: Type, sym2: Symbol, depth: Int): Boolean = annotsInferMode {
